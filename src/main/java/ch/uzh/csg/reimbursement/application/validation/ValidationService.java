		...
		Map<String, Pattern> map = new HashMap<String, Pattern>() {
			{
				...
				put("expense.date", compile("^(((20)(([0][48])|([2468][048])|([13579][26]))|2000)[\\-](([0][13578]|[1][02])[\\-]([012][0-9]|[3][01])|([0][469]|11)[\\-]([012][0-9]|30)|02[\\-]([012][0-9]))|((20)(([02468][1235679])|([13579][01345789])))[\\-](([0][13578]|[1][02])[\\-]([012][0-9]|[3][01])|([0][469]|11)[\\-]([012][0-9]|30)|02[\\-]([012][0-8])))$"));
